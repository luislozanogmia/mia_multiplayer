  ...
  (function(){
    ...
    function googleAccountPanel(entry, panelId){
      ...
      return '<article class="hermes-connector hermes-google-account" data-hermes-connector="' + GOOGLE_ACCOUNT_ID + '">' +
        ...
        '<span class="styled-connector-desc">Connect Gmail, Calendar, Drive, Contacts, Docs, and Sheets with one secure sign-in.</span></span>' +
        actionButton + '</div>' +
        ...
        '<p class="hermes-connector-setup-note"><strong>Access requested:</strong> Gmail, Calendar, Drive, Contacts, Docs, and Sheets. Delete, clear, and trash actions are blocked.</p>' +
